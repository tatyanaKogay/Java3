...
public class SqlClient {
    ...
    synchronized static void changeNick(String nickname, String newNickname){
        String request = String.format("update users set nickname = '%s' where nickname = '%s'", newNickname, nickname);
        try {
            Integer resultSet = statement.executeUpdate(request);
